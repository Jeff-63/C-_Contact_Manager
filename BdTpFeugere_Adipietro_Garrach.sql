...
GO
insert Users values ('toto', '123456',0)
insert Users values ('tata', 'abcd',1)

insert Contact values ('Feugere','Jean-françois', '1 Place Ville-Marie', 'Montréal', 'QC', 'Canada', '(514)999-9999',1)
insert Contact values ('Garrach','Nadia', '2 Place Ville-Marie', 'Montréal', 'QC', 'Canada', '(514)999-9998',1)
insert Contact values ('Sane','David', '919 19th St NW', 'Washington', 'DC', 'États-Unis', '(202)510-9917',1)
insert Contact values ('Percia','Sebastien', '14 Rue Saint-Antoine', 'Marseille', 'Provence-Alpes-Côte d''Azur', 'France', null,1)
insert Contact values ('Adipietro','Jason', '3 Place Ville-Marie', 'Montréal', 'QC', 'Canada', '(514)999-9997',2)
GO
